...
echo "export USERNAME=your_ssh_username"
echo "docker run -it --rm --name ansible -e \"ANSIBLE_REMOTE_USER=\${USERNAME}\" -v ~/.ssh:/root/.ssh -v ~/.finanztip:/root/.finanztip -v \$(pwd):/mnt ansible_finanztip:latest"
echo ""
